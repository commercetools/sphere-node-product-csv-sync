...
module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    coffeelint:
      options:
        force: true # report CoffeeLint errors but not fail the task
        configFile: grunt.file.readJSON('node_modules/sphere-coffeelint/coffeelint.json')
    ...
    coffee:
      ...
      test:
        ...
        flatten: true
        cwd: "src/spec"
        src: ["*.spec.coffee", "integration/*.spec.coffee"]
        dest: "test"
        ext: ".spec.js"
      unittest:
        expand: true
