...
module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    shell:
      ...
      coverage:
        command: "node_modules/.bin/istanbul cover jasmine --stop-on-failure=true test/**/*spec.js && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage"
      publish:
        command: 'npm publish'
