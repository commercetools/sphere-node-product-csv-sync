    ...
    return new Promise(function(resolve, reject) {
      if (opts.csv) {
        ...
        .catch(function(err) {
          ...
          return process.exit(2);}).then(content =>
    ...
    program
      ...
      .action(opts => {
        ...
        .then(function(credentials) {
          ...
          return _subCommandHelp('import');}).done();
    });
    ...
    program
      ...
      .action(opts => {
        ...
        .then(credentials => {
          ...
          const publish = (() => { switch (opts.changeTo) {
          ...
          const run = () => {
            return this._getFilterFunction(opts)
            .then(function(filterFunction) {
              const importer = new Importer(options);
              importer.continueOnProblems = opts.continueOnProblems;
              return importer.changeState(publish, remove, filterFunction);}).then(function(result) {
              console.warn(result);
              return process.exit(0);}).catch(function(err) {
              if (err.stack) { console.error(err.stack); }
              console.error(err);
              return process.exit(1);}).done();
          };
          ...
          console.error(`Problems on getting client credentials from config files: ${err}`);
          return _subCommandHelp('state');}).done();
    });
    ...
    program
      ...
      .action(opts => {
        ...
        .then(function(credentials) {
          ...
          console.error(`Problems on getting client credentials from config files: ${err}`);
          return _subCommandHelp('export');}).done();
    });
    ...
    program
      ...
      .action(opts => {
        ...
        .then(function(credentials) {
          ...
          console.error(`Problems on getting client credentials from config files: ${err}`);
          return _subCommandHelp('template');}).done();
    });
