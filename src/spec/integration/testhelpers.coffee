...
getAllAttributesByConstraint = (constraint) ->
  ...
  [
    ...
    { type: { name: 'set', elementType: { name: 'reference', referenceTypeId: 'comment' } }, name: "attr-set-ref-comment-#{lowerConstraint}", label: { en: "Attribute SET-REFERENCE-COMMENT #{constraint}" }, attributeConstraint: constraint, isRequired: false, isSearchable: false }
